...
_SYSTEM_PROMPT = (
    ...
    "'sleeping', 'speaking'). For numeric sensor values (CPU temp, RAM, "
    "brightness, finger count) always use show_value not display_text. "
    "show_value displays large centered numbers. display_text is for sentences "
    "and weather text only. OLED action inputs use: text, font_size, x, y, "
